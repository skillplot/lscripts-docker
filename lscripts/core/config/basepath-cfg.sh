...
# local _LSD__WORKSPACE_ROOT="${LSCRIPTS__WORKSPACE_ROOT}"
...
local _LSD__DOCKER_CODEHUB_ROOT="${_LSD__CODEHUB_ROOT}"
...
[[ ! -z "${_LSD__DOCKER_CODEHUB_ROOT}" ]] || _LSD__DOCKER_CODEHUB_ROOT="/codehub"
