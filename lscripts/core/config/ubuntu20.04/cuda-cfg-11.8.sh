...
##----------------------------------------------------------
## CUDA Stack 11.8, Nvidia Driver: 525+
...
##----------------------------------------------------------
local CUDA_VER="11.8"
local CUDA_PKG="${CUDA_VER}.0-1"
local CUDA_REL=$(echo ${CUDA_VER} | tr . -) ## 11-8
...
local NVML_VERSION="${CUDA_REL}=${CUDA_VER}.86-1"
...
local CUDNN_VERSION="8.6.0.163"
local CUDNN_VERSION="8.8.0.121"
local CUDNN_VERSION="8.8.1.3"
local CUDNN_VERSION="8.9.0.131"
local CUDNN_VERSION="8.9.1.23"
local CUDNN_VERSION="8.9.2.26"
...
local NCCL_VERSION="2.15.1"
local NCCL_VERSION="2.15.5"
...
local LIBNVINFER_VERSION="8.5.1"
local LIBNVINFER_VERSION="8.5.2"
local LIBNVINFER_VERSION="8.5.3"
local LIBNVINFER_VERSION="8.6.0.12"
local LIBNVINFER_VERSION="8.6.1.6"
