...
function lsd-lscripts.alias.main() {
  ...
  alias lsd-utils.pkill.update-manager="bash ${LSCRIPTS}/exec_cmd.sh cmd=lsd-mod.utils.pkill.update-manager"
  ...
  alias lsd-utils.w3m.captive-portal="bash ${LSCRIPTS}/exec_cmd.sh cmd=lsd-mod.utils.w3m.captive-portal $@"
