...
Why is it so hard to find a good documentation of the available API endpoints and API versions?

Credit:
https://bitbucket.org/denilsonsa/small_scripts/src/default/docker_remote_tags.sh
raw file: https://bitbucket.org/denilsonsa/small_scripts/raw/54a4ed1d5ed621266a19b763bf243f827ff6684d/docker_remote_tags.py

# python docker_remote_tags.py redis | tr ',' '\n'
"""
...
def get_docker_images():
  client = docker.from_env()
  docker_img_list = client.images.list()
  for image in docker_img_list:
    print(image.id)
  return docker_img_list
